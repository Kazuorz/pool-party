...
const Landing = () => {
  return (
    <div className="mx-48">
      <ImgContainer source="/Placeholder.png" alt="" cName="w-full h-96 pt-8" />
      ...
      <div className="ml-24 mt-8 space-y-8">
        <div>
          ...
          <p className="text-justify">
            This website was also made by a guy who was desperately looking for
            the perfect beatmap and was tailored towards both finding that
        ...
        <div className="flex flex-row space-x-12">
          <div className="flex-1">
            <ImgContainer source="/Placeholder.png" cName="w-full h-full" />
          </div>
          <div className="flex-1 flex flex-col justify-center">
            <h3>Curious about the tournament button?</h3>
            <p>
              We’ve recopiled a bunch of tournaments and their pools so you can
              easily look for those in specific. Worried your amazing newly
              found pick has been already in another tournament? We’ve made sure
              you’ll know if that’s the case.
            </p>
          </div>
        </div>
        <div className="flex flex-row space-x-12">
          <div className="flex flex-col flex-1 justify-center">
            ...
            <p>
              ...
              map pool, you can do so! Just Register clicking the Log In button
              and start crafting your own pool.
            </p>
          </div>
          <div className="flex-1">
            <ImgContainer source="/Placeholder.png" cName="w-full h-full" />
